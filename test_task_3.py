...
model = Deepset().cuda()
model.load_state_dict(torch.load('./train_task_3_statedict/best.pth'))
correct_total = 0
total = 0
with torch.no_grad():
...
val_set = Dataset_copy('./data/task_3_data/test.npy','./data/task_3_data/test_label.npy')
val_loader = data.DataLoader(val_set)
...
for i in range(1,15):
    dataset_path = './data/task_3_data/test_'+str(10*i)+'.npy'
    label_path = './data/task_3_data/test_label_'+str(10*i)+'.npy'
