...
if not os.path.exists('./train_task_0_statedict'):
    os.mkdir('./train_task_0_statedict')

if not os.path.exists('./task_0_fig'):
    os.mkdir('./task_0_fig')
...
print('==================training====================')
dataset = Dataset_copy('./data/task_0_data/task_0_train.npy')
val_set = Dataset_copy('./data/task_0_data/task_0_val.npy')
val_dif_set = Dataset_copy('./data/task_0_data/task_0_test_50.npy')
...
for epoch in range(EPOCHs):
    ...
    print('validation accuracy:' + str(100*correct_total/total) + '%')
    with torch.no_grad():
        val_loss = 0
...
plt.ylabel('loss')
plt.legend()
plt.savefig('./task_0_fig/loss_curve_3_pelayers.png')