...
from dataset_task_3 import Dataset_copy
...
if not os.path.exists('./train_task_3_statedict'):
    os.mkdir('./train_task_3_statedict')

if not os.path.exists('./task_3_fig'):
    os.mkdir('./task_3_fig')
...
val_loss_same_size = []
val_loss_dif_size = []
dataset = Dataset_copy('./data/task_3_data/task_train.npy','./data/task_3_data/train_label.npy')
val_set = Dataset_copy('./data/task_3_data/val.npy','./data/task_3_data/val_label.npy')
val_dif_set = Dataset_copy('./data/task_3_data/test_60.npy','./data/task_3_data/test_label_60.npy')
...
for epoch in range(EPOCHs):
    ...
    if correct_total/total > best_acc:
        ...
        torch.save(model.state_dict(), './train_task_3_statedict/best.pth')
    else:
        flag += 1
        if flag == early_stop:
            break
...
plt.ylabel('loss')
plt.legend()
plt.savefig('./task_3_fig/loss_curve_1_pelayers.png')
# x_list= []
